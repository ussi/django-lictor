...
Lictor.Step = go.Class({
    ...
    'HTML_PATTERN': "<div class='lictor-step'><label style='background-color: inherit;'>{{ title }}</label><div class='content loading'></div></div>",
    ...
    'createNode': (function () {
        this.node = $(this.HTML_PATTERN.replace("{{ title }}", moment(this.title).format('Do MMMM, HH:MM:SS')));
        this.pos(0);
    }),
